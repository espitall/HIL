...
THIGH_MID_INTERNAL_P1_SCREW_HOLE_LENGTH = 100;
...
/*
 * define constants of thigh_high
 */
THIGH_HIGH_STL = "high thigh";
THIGH_HIGH_CUT = 300;

/*
 * define constants of thigh_high_internal_p1
 */
THIGH_HIGH_INTERNAL_P1_OFFSET = [-3, 9, 1];
THIGH_HIGH_INTERNAL_P1_THIGH_MID_HEAD_SCREW_HOLE_RADIUS = 12 / 2;
THIGH_HIGH_INTERNAL_P1_THIGH_MID_HEAD_SCREW_HOLE_OFFSET = [0, 0, 50];
